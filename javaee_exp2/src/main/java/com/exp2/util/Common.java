...
import com.exp2.model.VoObject;
...
public class Common {
     ...
     * @return
     */
    public static Object getRetObject(com.exp2.util.ReturnObject<VoObject> returnObject) {
    ...
    public static Object getNullRetObj(com.exp2.util.ReturnObject<Object> returnObject, HttpServletResponse httpServletResponse) {
        ResponseCode code = returnObject.getCode();
        switch (code) {
