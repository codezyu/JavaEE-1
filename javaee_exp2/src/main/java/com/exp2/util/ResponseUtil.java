...
public class ResponseUtil {
    public static Object ok() {
        ...
        obj.put("errno", com.exp2.util.ResponseCode.OK.getCode());
        obj.put("errmsg", com.exp2.util.ResponseCode.OK.getMessage());
        return obj;
    }
    ...
    public static Object fail(com.exp2.util.ResponseCode code) {
        Map<String, Object> obj = new HashMap<String, Object>();
    ...
    public static Object fail(com.exp2.util.ResponseCode code, String errmsg) {
        Map<String, Object> obj = new HashMap<String, Object>();
        obj.put("errno", code.getCode());
